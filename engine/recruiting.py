...
class Recruit:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "true_speed": self.true_speed,
            "true_stamina": self.true_stamina,
            "true_agility": self.true_agility,
            "true_power": self.true_power,
            "true_awareness": self.true_awareness,
            "true_hands": self.true_hands,
            "true_kicking": self.true_kicking,
            "true_kick_power": self.true_kick_power,
