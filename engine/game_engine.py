...
OFFENSE_STYLES = {
    ...
    "six_shooter": {
        "label": "Six Shooter",
        "description": "Phase offense built around the 6-down structure. Run-heavy setup on downs 1-4, then pull the trigger in Kick Mode.",
        "weights": {
            "dive_option": 0.13,
            "power": 0.11,
            "sweep_option": 0.06,
        ...
        "weights_kick_mode": {
            "dive_option": 0.08, "power": 0.06, "sweep_option": 0.01,
            "speed_option": 0.04, "counter": 0.02, "draw": 0.05,
            "viper_jet": 0.02, "lateral_spread": 0.02, "kick_pass": 0.15,
            "trick_play": 0.02, "snap_kick": 0.35, "field_goal": 0.20, "punt": 0.02,
        },
        "tempo": 0.50,
        "lateral_risk": 0.6,
        "kick_rate": 0.25,
        ...
        "pindown_bonus": 0.04,
        "run_vs_lateral": 0.70,
        "early_down_aggression": 0.75,
        "early_down_run_rate": 0.80,
        "red_zone_run_pct": 0.80,
        "kick_mode_aggression": 0.85,
        "snap_kick_aggression": 1.6,
        "phase_shift": True,
        "kick_pass_weights": {
            "quick_kick": 0.50, "territory": 0.30, "bomb": 0.05, "kick_lateral": 0.15,
        },
        "kick_pass_weights_kick_mode": {
            "quick_kick": 0.60, "territory": 0.20, "bomb": 0.0, "kick_lateral": 0.20,
        },
        "formation_weights": {"tight": 0.25, "split": 0.30, "spread": 0.20, "heavy": 0.25},
    },
    "quick_strike": {
        "label": "Quick Strike",
        "description": "Transition offense. Score in 2-4 plays off turnovers and bonus possessions. Fast, vertical, ruthless.",
        "weights": {
            "dive_option": 0.04,
            "power": 0.03,
            "sweep_option": 0.06,
        ...
        "fatigue_resistance": 0.0,
        "kick_accuracy_bonus": 0.0,
        "explosive_lateral_bonus": 0.06,
        "option_read_bonus": 0.03,
        "broken_play_bonus": 0.06,
        "pindown_bonus": 0.0,
        "run_vs_lateral": 0.40,
        "early_down_aggression": 0.90,
        "red_zone_run_pct": 0.55,
        "kick_mode_aggression": 0.45,
        "transition_yards_bonus": 0.12,
        "bonus_possession_aggression": 1.4,
        "short_drive_efficiency": 0.08,
        "kick_pass_weights": {
            "quick_kick": 0.20, "territory": 0.35, "bomb": 0.30, "kick_lateral": 0.15,
        },
        "formation_weights": {"tight": 0.10, "split": 0.25, "spread": 0.55, "heavy": 0.10},
    },
    "mousetrap": {
        "label": "Mousetrap",
        "description": "Bait and switch. Feed the DC predictable looks, let them solve it, then punish the over-adjustment.",
        "weights": {
            "dive_option": 0.06,
            "power": 0.05,
            "sweep_option": 0.06,
        ...
        "weights_bait": {
            "dive_option": 0.18, "power": 0.16, "sweep_option": 0.08,
            "speed_option": 0.04, "counter": 0.03, "draw": 0.03,
            "viper_jet": 0.02, "lateral_spread": 0.04, "kick_pass": 0.20,
            "trick_play": 0.02, "snap_kick": 0.10, "field_goal": 0.06, "punt": 0.04,
        },
        "tempo": 0.55,
        "lateral_risk": 0.9,
        "kick_rate": 0.20,
        ...
        "pindown_bonus": 0.02,
        "run_vs_lateral": 0.50,
        "early_down_aggression": 0.65,
        "red_zone_run_pct": 0.65,
        "kick_mode_aggression": 0.45,
        "bait_phase": True,
        "bait_phase_plays": 8,
        "adaptation_exploit_bonus": 0.10,
        "counter_tendency_bonus": 0.08,
        "kick_pass_weights": {
            "quick_kick": 0.30, "territory": 0.35, "bomb": 0.15, "kick_lateral": 0.20,
        },
        "kick_pass_weights_bait": {
            "quick_kick": 0.75, "territory": 0.20, "bomb": 0.0, "kick_lateral": 0.05,
        },
        "formation_weights": {"tight": 0.20, "split": 0.35, "spread": 0.25, "heavy": 0.20},
    },
    "mismatch": {
        "label": "Mismatch",
        "description": "Matchup hunting. Read the defense, find the weak link, attack it relentlessly with the Viper.",
        "weights": {
            "dive_option": 0.06,
            "power": 0.04,
            "sweep_option": 0.08,
        ...
        "red_zone_run_pct": 0.65,
        "kick_mode_aggression": 0.40,
        "viper_touch_rate": 0.40,
        "matchup_exploit_bonus": 0.10,
        "pre_snap_read_bonus": 0.08,
        "personnel_grouping_shifts": True,
        "kick_pass_weights": {
            "quick_kick": 0.25, "territory": 0.40, "bomb": 0.10, "kick_lateral": 0.25,
        },
        "formation_weights": {"tight": 0.15, "split": 0.35, "spread": 0.40, "heavy": 0.10},
    },
    "ironclad": {
        "label": "Ironclad",
        "description": "Iowa football as Viperball. Suffocating grind, maximum clock burn, win 15-12. Boring and beautiful.",
        "weights": {
            "dive_option": 0.16,
            "power": 0.15,
            "sweep_option": 0.05,
        ...
        "pindown_bonus": 0.06,
        "run_vs_lateral": 0.90,
        "early_down_aggression": 0.40,
        "red_zone_run_pct": 0.90,
        "kick_mode_aggression": 0.70,
        "snap_kick_aggression": 1.4,
        "clock_burn_multiplier": 1.44,
        "punt_aggression": 1.3,
        "field_position_priority": 0.90,
        "turnover_aversion": 0.95,
        "kick_pass_weights": {
            "quick_kick": 0.85, "territory": 0.15, "bomb": 0.0, "kick_lateral": 0.0,
        },
        "formation_weights": {"tight": 0.35, "split": 0.15, "spread": 0.05, "heavy": 0.45},
    },
}
...
OFFENSE_VS_DEFENSE_MATCHUP = {
    ...
    # Six Shooter — patient phase game; fortress stops the run, drift lets phases develop
    ("six_shooter", "swarm"): 0.975,
    ("six_shooter", "blitz_pack"): 0.95,
    ("six_shooter", "shadow"): 1.025,
    ("six_shooter", "fortress"): 0.925,
    ("six_shooter", "predator"): 0.94,
    ("six_shooter", "drift"): 1.05,
    ("six_shooter", "chaos"): 0.96,
    ("six_shooter", "lockdown"): 1.06,    # coverage wasted early, snap kicks late
    # Quick Strike — explosive transition scoring; drift/lockdown deny the big play
    ("quick_strike", "swarm"): 1.025,
    ("quick_strike", "blitz_pack"): 1.06,
    ("quick_strike", "shadow"): 0.95,
    ("quick_strike", "fortress"): 1.04,
    ("quick_strike", "predator"): 0.96,
    ("quick_strike", "drift"): 0.925,
    ("quick_strike", "chaos"): 1.025,
    ("quick_strike", "lockdown"): 0.91,    # HARD COUNTER — coverage smothers quick passing
    # Mousetrap — exploits defenses that commit; drift/chaos don't bite on bait
    ("mousetrap", "swarm"): 1.025,
    ("mousetrap", "blitz_pack"): 0.975,
    ("mousetrap", "shadow"): 1.04,
    ("mousetrap", "fortress"): 0.96,
    ("mousetrap", "predator"): 1.06,     # predator gambles hard, gets trapped
    ("mousetrap", "drift"): 0.95,
    ("mousetrap", "chaos"): 0.975,
    ("mousetrap", "lockdown"): 1.025,
    # Mismatch — hunts weak links; shadow man-coverage negates matchup hunting
    ("mismatch", "swarm"): 1.04,
    ("mismatch", "blitz_pack"): 1.025,
    ("mismatch", "shadow"): 0.90,         # HARD COUNTER — man coverage = no mismatch
    ("mismatch", "fortress"): 1.05,
    ("mismatch", "predator"): 1.025,
    ("mismatch", "drift"): 0.96,
    ("mismatch", "chaos"): 1.00,
    ("mismatch", "lockdown"): 0.94,
    # Ironclad — Iowa grind; fortress is built for this, lockdown wastes coverage on a run team
    ("ironclad", "swarm"): 0.96,
    ("ironclad", "blitz_pack"): 0.96,
    ("ironclad", "shadow"): 1.05,
    ("ironclad", "fortress"): 0.90,       # HARD COUNTER — fortress built to stop the grind
    ("ironclad", "predator"): 0.94,
    ("ironclad", "drift"): 1.06,
    ("ironclad", "chaos"): 0.95,
    ("ironclad", "lockdown"): 1.08,       # coverage completely wasted
}
...
class ViperballEngine:
    ...
    def simulate_drive(self, is_bonus_drive: bool = False):
        self._is_bonus_drive = is_bonus_drive
        ...
        while self.drive_play_count < max_plays and self.state.time_remaining > 0:
            ...
            if play.result in ("snap_kick_recovery", "missed_snap_kick_retained"):
    ...
    def select_kick_decision(self) -> PlayType:
        ...
        # ── Down 4: ALWAYS KEEP DRIVING ──
        # 4th down is for advancing.  You still have 5th and 6th down.
        # There is virtually no reason to kick on 4th down — use this
        # down to improve field position for a 6th-down kick, or keep
        # chasing the 9-point touchdown.
        #
        # The only exception is absolute desperation clock (end of half
        # with under 45 seconds) where there literally isn't time to
        # run more plays.  Even then, only kick on a bonus possession
        # where the drive is "free" anyway.
        if down == 4:
            desperation_clock = (
                (quarter in (2, 4) and time_left <= 45)
            )
        ...
        # ── Down 5: SAVE IT FOR 6TH DOWN ──
        # 5th down should be used to advance.  6th down is the kicking
        # down — gaining even a few yards on 5th improves the 6th-down
        # kick significantly.  Only kick on 5th when:
        #   (a) Clock pressure (end of half / late Q4) AND long yardage
        #       that you're unlikely to convert, OR
        #   (b) Bonus possession — the drive is "free" and you want to
        #       cash in points quickly.
        if down == 5:
            is_bonus = getattr(self, '_is_bonus_drive', False)

            # Bonus possessions: more liberal — cash in points.
            # Still prefer going for it on short yardage.
            if is_bonus and ytg >= 8 and best_kick and not dk_futile:
                return best_kick

            # Clock pressure: end of half or late Q4 with long yardage.
            # This is the only non-bonus situation where a 5th-down kick
            # is justified.  Must be a truly long ytg (unlikely to convert).
            if clock_pressure and ytg >= 12 and best_kick:
    ...
    def _check_snap_kick_shot_play(self) -> Optional[PlayType]:
        """Snap kick shot check — DISABLED for downs 1-3.

        Kicks belong on 6th down (the kicking down), with rare exceptions
        on 5th down under clock pressure or bonus possessions.  There is
        no reason to waste a down kicking when you still have downs left
        to advance toward a 9-point touchdown.

        This function is no longer called for downs 1-3 (the call site
        guards with down >= 2 and down <= 3, but even if reached, it
        returns None immediately).  The logic is preserved for downs 4-5
        only as an extreme-rarity fallback.
        """
        down = self.state.down
        # Downs 1-3: NEVER kick.  Use your downs to advance.
        if down <= 3:
            return None
        if down > 5:
            return None

        # Downs 4-5: only in extreme situations (handled by
        # select_kick_decision in the main flow).  This function
        # is a secondary check — return None to defer to the
        # primary kick decision logic.
        return None
    ...
    def _simulate_play_core(self) -> Play:
        ...
        # 4th down is for driving.  Kicking on 4th is almost never
        # justified — you still have 5th and 6th down.  Only the
        # most extreme desperation clock + bonus possession triggers
        # a kick here (see select_kick_decision).
        ...
        # ── Down 5-6 without kick mode: forced kick decision ──
        ...
        # ── Downs 1-3: always run a normal play — no kicks ──
        # Kicks belong on 6th down.  No snap kick interrupts on early downs.
    ...
    def select_play_family(self, formation: str = "split") -> PlayFamily:
        ...
        # ── Downs 1-5: no kicking via play selection ──
        # Kicks belong on 6th down.  On downs 1-5 the offense should
        # always be advancing toward a 9-point touchdown.  Kicking
        # decisions on downs 4-6 are handled by select_kick_decision()
        # in the main simulate_play_core flow — not by random weight
        # selection.  Zero out all kick families here to prevent the
        # weighted random from ever selecting a kick before 6th down.
        #
        # Exception: absolute desperation clock (Q2/Q4 under 45 seconds)
        # when there literally isn't time to run more plays.
        quarter = self.state.quarter
        time_left = self.state.time_remaining
        ...
        # V3.2: Final down-gate enforcement after ALL modifiers.
        # No downstream code (lead management, style situational, etc.)
        # should override the fundamental rule: kicks on 6th down only.
        if down <= 5 and not desperation_clock:
            weights["snap_kick"] = 0.0
            weights["field_goal"] = 0.0
            weights["punt"] = 0.0
        ...
        if style_name == "ground_pound":
            ...
            if fp >= launch_pad and fp < 85:
                ...
                for k, v in attack_weights.items():
                    weights[k] = v
                # Re-apply kick gate: attack weights must not override the
                # downs 1-5 kick suppression.  Kicks belong on 6th down.
                if down <= 5:
        ...
        if random.random() < success_prob:
            ...
            if ball_landing >= 100:
                ...
                if is_pindown:
                    ...
                    play = Play(
                        ...
                        result=PlayResult.PINDOWN.value,
                        description=f"{ptag} drop kick {distance}yd — NO GOOD, into the end zone — PINDOWN! +1",
                        fatigue=round(stamina, 1),
                    )
                    self._apply_rouge_pindown(kicking_team, receiving)
                    return play
                    ...
                    return Play(
                        ...
                        description=f"{ptag} drop kick {distance}yd — NO GOOD, returned out of end zone to {self.state.field_position}",
                        fatigue=round(stamina, 1),
                    )
            ...
            if random.random() < recovery_chance:
                ...
                return Play(
                    ...
                    result=PlayResult.SNAP_KICK_RECOVERY.value,
                    description=f"{ptag} drop kick {distance}yd — NO GOOD → LIVE BALL! Kicking team recovers at {landing_spot}!",
                    fatigue=round(stamina, 1),
                )
            else:
                self.change_possession()
                ...
                return Play(
                    ...
                    yards_gained=0,
                    result=PlayResult.MISSED_KICK.value,
                    description=f"{ptag} drop kick {distance}yd — NO GOOD → LIVE BALL! Defense recovers (+½)",
                    fatigue=round(stamina, 1),
                )
