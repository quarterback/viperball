...
NEW_SCHOOLS = [
    ...
    # ══════════════════════════════════════════════════════════════════
    {"id": "illinois", "name": "Illinois", "abbrev": "ILL", "mascot": "Fighting Illini", "city": "Champaign", "state": "IL", "colors": ["Orange", "Blue"], "conference": "Big Ten", "tier": 85},
    {"id": "indiana", "name": "Indiana", "abbrev": "IND", "mascot": "Hoosiers", "city": "Bloomington", "state": "IN", "colors": ["Crimson", "Cream"], "conference": "Big Ten", "tier": 83},
    {"id": "iowa", "name": "Iowa", "abbrev": "IOWA", "mascot": "Hawkeyes", "city": "Iowa City", "state": "IA", "colors": ["Black", "Gold"], "conference": "Big Ten", "tier": 86},
    {"id": "michigan", "name": "Michigan", "abbrev": "MICH", "mascot": "Wolverines", "city": "Ann Arbor", "state": "MI", "colors": ["Maize", "Blue"], "conference": "Big Ten", "tier": 93},
    {"id": "michigan_state", "name": "Michigan State", "abbrev": "MSU", "mascot": "Spartans", "city": "East Lansing", "state": "MI", "colors": ["Green", "White"], "conference": "Big Ten", "tier": 87},
    {"id": "nebraska", "name": "Nebraska", "abbrev": "NEB", "mascot": "Cornhuskers", "city": "Lincoln", "state": "NE", "colors": ["Scarlet", "Cream"], "conference": "Big Ten", "tier": 88},
    {"id": "northwestern", "name": "Northwestern", "abbrev": "NW", "mascot": "Wildcats", "city": "Evanston", "state": "IL", "colors": ["Purple", "White"], "conference": "Big Ten", "tier": 82},
    {"id": "notre_dame", "name": "Notre Dame", "abbrev": "ND", "mascot": "Fighting Irish", "city": "Notre Dame", "state": "IN", "colors": ["Navy", "Gold"], "conference": "Big Ten", "tier": 94},
    {"id": "ohio_state", "name": "Ohio State", "abbrev": "OSU", "mascot": "Buckeyes", "city": "Columbus", "state": "OH", "colors": ["Scarlet", "Gray"], "conference": "Big Ten", "tier": 95},
    {"id": "purdue", "name": "Purdue", "abbrev": "PUR", "mascot": "Boilermakers", "city": "West Lafayette", "state": "IN", "colors": ["Old Gold", "Black"], "conference": "Big Ten", "tier": 84},
    {"id": "wisconsin", "name": "Wisconsin", "abbrev": "WIS", "mascot": "Badgers", "city": "Madison", "state": "WI", "colors": ["Cardinal", "White"], "conference": "Big Ten", "tier": 88},
    # ══════════════════════════════════════════════════════════════════
    ...
    {"id": "clemson", "name": "Clemson", "abbrev": "CLEM", "mascot": "Tigers", "city": "Clemson", "state": "SC", "colors": ["Orange", "Purple"], "conference": "ACC", "tier": 92},
    {"id": "duke", "name": "Duke", "abbrev": "DUKE", "mascot": "Blue Devils", "city": "Durham", "state": "NC", "colors": ["Royal Blue", "White"], "conference": "ACC", "tier": 82},
    {"id": "florida_state", "name": "Florida State", "abbrev": "FSU", "mascot": "Seminoles", "city": "Tallahassee", "state": "FL", "colors": ["Garnet", "Gold"], "conference": "ACC", "tier": 90},
    ...
    {"id": "louisville", "name": "Louisville", "abbrev": "LOU", "mascot": "Cardinals", "city": "Louisville", "state": "KY", "colors": ["Cardinal", "Black"], "conference": "ACC", "tier": 85},
    {"id": "maryland", "name": "Maryland", "abbrev": "UMD", "mascot": "Terrapins", "city": "College Park", "state": "MD", "colors": ["Red", "White", "Black", "Gold"], "conference": "ACC", "tier": 84},
    {"id": "miami", "name": "Miami", "abbrev": "MIA", "mascot": "Hurricanes", "city": "Coral Gables", "state": "FL", "colors": ["Orange", "Green", "White"], "conference": "ACC", "tier": 90},
    {"id": "nc_state", "name": "NC State", "abbrev": "NCST", "mascot": "Wolfpack", "city": "Raleigh", "state": "NC", "colors": ["Red", "White"], "conference": "ACC", "tier": 84},
    {"id": "north_carolina", "name": "North Carolina", "abbrev": "UNC", "mascot": "Tar Heels", "city": "Chapel Hill", "state": "NC", "colors": ["Carolina Blue", "White"], "conference": "ACC", "tier": 86},
    {"id": "pitt", "name": "Pittsburgh", "abbrev": "PITT", "mascot": "Panthers", "city": "Pittsburgh", "state": "PA", "colors": ["Royal Blue", "Gold"], "conference": "ACC", "tier": 83},
    {"id": "syracuse", "name": "Syracuse", "abbrev": "SYR", "mascot": "Orange", "city": "Syracuse", "state": "NY", "colors": ["Orange", "Blue"], "conference": "ACC", "tier": 83},
    {"id": "virginia", "name": "Virginia", "abbrev": "UVA", "mascot": "Cavaliers", "city": "Charlottesville", "state": "VA", "colors": ["Orange", "Navy"], "conference": "ACC", "tier": 84},
    ...
    {"id": "wake_forest", "name": "Wake Forest", "abbrev": "WAKE", "mascot": "Demon Deacons", "city": "Winston-Salem", "state": "NC", "colors": ["Old Gold", "Black"], "conference": "ACC", "tier": 80},
    # ══════════════════════════════════════════════════════════════════
    # SEC (16 new teams — renamed from Southern Sun)
    # ══════════════════════════════════════════════════════════════════
    {"id": "alabama", "name": "Alabama", "abbrev": "BAMA", "mascot": "Crimson Tide", "city": "Tuscaloosa", "state": "AL", "colors": ["Crimson", "White"], "conference": "SEC", "tier": 95},
    {"id": "arkansas", "name": "Arkansas", "abbrev": "ARK", "mascot": "Razorbacks", "city": "Fayetteville", "state": "AR", "colors": ["Cardinal", "White"], "conference": "SEC", "tier": 85},
    {"id": "auburn", "name": "Auburn", "abbrev": "AUB", "mascot": "Tigers", "city": "Auburn", "state": "AL", "colors": ["Burnt Orange", "Navy"], "conference": "SEC", "tier": 89},
    {"id": "florida", "name": "Florida", "abbrev": "UF", "mascot": "Gators", "city": "Gainesville", "state": "FL", "colors": ["Orange", "Blue"], "conference": "SEC", "tier": 91},
    {"id": "georgia", "name": "Georgia", "abbrev": "UGA", "mascot": "Bulldogs", "city": "Athens", "state": "GA", "colors": ["Red", "Black"], "conference": "SEC", "tier": 94},
    {"id": "kentucky", "name": "Kentucky", "abbrev": "UK", "mascot": "Wildcats", "city": "Lexington", "state": "KY", "colors": ["Blue", "White"], "conference": "SEC", "tier": 83},
    {"id": "lsu", "name": "Louisiana State", "abbrev": "LSU", "mascot": "Tigers", "city": "Baton Rouge", "state": "LA", "colors": ["Purple", "Gold"], "conference": "SEC", "tier": 92},
    {"id": "mississippi_state", "name": "Mississippi State", "abbrev": "MSST", "mascot": "Bulldogs", "city": "Starkville", "state": "MS", "colors": ["Maroon", "White"], "conference": "SEC", "tier": 83},
    {"id": "missouri", "name": "Missouri", "abbrev": "MIZ", "mascot": "Tigers", "city": "Columbia", "state": "MO", "colors": ["Black", "Gold"], "conference": "SEC", "tier": 84},
    {"id": "oklahoma", "name": "Oklahoma", "abbrev": "OU", "mascot": "Sooners", "city": "Norman", "state": "OK", "colors": ["Crimson", "Cream"], "conference": "SEC", "tier": 93},
    {"id": "ole_miss", "name": "Mississippi", "abbrev": "MISS", "mascot": "Rebels", "city": "Oxford", "state": "MS", "colors": ["Red", "Blue"], "conference": "SEC", "tier": 85},
    {"id": "south_carolina", "name": "South Carolina", "abbrev": "SC", "mascot": "Gamecocks", "city": "Columbia", "state": "SC", "colors": ["Garnet", "Black"], "conference": "SEC", "tier": 84},
    {"id": "tennessee", "name": "Tennessee", "abbrev": "TENN", "mascot": "Volunteers", "city": "Knoxville", "state": "TN", "colors": ["Orange", "White"], "conference": "SEC", "tier": 90},
    {"id": "texas", "name": "Texas", "abbrev": "TEX", "mascot": "Longhorns", "city": "Austin", "state": "TX", "colors": ["Burnt Orange", "White"], "conference": "SEC", "tier": 94},
    {"id": "texas_am", "name": "Texas A&M", "abbrev": "TAMU", "mascot": "Aggies", "city": "College Station", "state": "TX", "colors": ["Maroon", "White"], "conference": "SEC", "tier": 88},
    {"id": "vanderbilt", "name": "Vanderbilt", "abbrev": "VAN", "mascot": "Commodores", "city": "Nashville", "state": "TN", "colors": ["Black", "Gold"], "conference": "SEC", "tier": 76},
    # ══════════════════════════════════════════════════════════════════
    # MOONSHINE LEAGUE / Big 12 (16 new teams — keeps Moonshine name)
    # ══════════════════════════════════════════════════════════════════
    {"id": "arizona", "name": "Arizona", "abbrev": "ARIZ", "mascot": "Wildcats", "city": "Tucson", "state": "AZ", "colors": ["Cardinal", "Navy"], "conference": "Moonshine League", "tier": 85},
    {"id": "arizona_state", "name": "Arizona State", "abbrev": "ASU", "mascot": "Sun Devils", "city": "Tempe", "state": "AZ", "colors": ["Maroon", "Gold"], "conference": "Moonshine League", "tier": 86},
    {"id": "baylor", "name": "Baylor", "abbrev": "BAY", "mascot": "Bears", "city": "Waco", "state": "TX", "colors": ["Green", "Gold"], "conference": "Moonshine League", "tier": 85},
    {"id": "byu", "name": "Brigham Young", "abbrev": "BYU", "mascot": "Cougars", "city": "Provo", "state": "UT", "colors": ["Royal Blue", "White"], "conference": "Moonshine League", "tier": 84},
    {"id": "cincinnati", "name": "Cincinnati", "abbrev": "CIN", "mascot": "Bearcats", "city": "Cincinnati", "state": "OH", "colors": ["Red", "Black"], "conference": "Moonshine League", "tier": 83},
    {"id": "colorado", "name": "Colorado", "abbrev": "CU", "mascot": "Buffaloes", "city": "Boulder", "state": "CO", "colors": ["Silver", "Gold", "Black"], "conference": "Moonshine League", "tier": 84},
    {"id": "houston", "name": "Houston", "abbrev": "UH", "mascot": "Cougars", "city": "Houston", "state": "TX", "colors": ["Scarlet", "White"], "conference": "Moonshine League", "tier": 83},
    {"id": "iowa_state", "name": "Iowa State", "abbrev": "ISU", "mascot": "Cyclones", "city": "Ames", "state": "IA", "colors": ["Cardinal", "Gold"], "conference": "Moonshine League", "tier": 84},
    {"id": "kansas", "name": "Kansas", "abbrev": "KU", "mascot": "Jayhawks", "city": "Lawrence", "state": "KS", "colors": ["Crimson", "Blue"], "conference": "Moonshine League", "tier": 82},
    {"id": "kansas_state", "name": "Kansas State", "abbrev": "KST", "mascot": "Wildcats", "city": "Manhattan", "state": "KS", "colors": ["Purple", "White"], "conference": "Moonshine League", "tier": 85},
    {"id": "oklahoma_state", "name": "Oklahoma State", "abbrev": "OKST", "mascot": "Cowboys", "city": "Stillwater", "state": "OK", "colors": ["Orange", "Black"], "conference": "Moonshine League", "tier": 85},
    {"id": "tcu", "name": "Texas Christian", "abbrev": "TCU", "mascot": "Horned Frogs", "city": "Fort Worth", "state": "TX", "colors": ["Purple", "White"], "conference": "Moonshine League", "tier": 85},
    {"id": "texas_tech", "name": "Texas Tech", "abbrev": "TTU", "mascot": "Red Raiders", "city": "Lubbock", "state": "TX", "colors": ["Scarlet", "Black"], "conference": "Moonshine League", "tier": 84},
    {"id": "ucf", "name": "Central Florida", "abbrev": "UCF", "mascot": "Knights", "city": "Orlando", "state": "FL", "colors": ["Black", "Gold"], "conference": "Moonshine League", "tier": 83},
    {"id": "utah", "name": "Utah", "abbrev": "UTAH", "mascot": "Utes", "city": "Salt Lake City", "state": "UT", "colors": ["Crimson", "White"], "conference": "Moonshine League", "tier": 85},
    {"id": "west_virginia", "name": "West Virginia", "abbrev": "WVU", "mascot": "Mountaineers", "city": "Morgantown", "state": "WV", "colors": ["Old Gold", "Blue"], "conference": "Moonshine League", "tier": 84},
    # ══════════════════════════════════════════════════════════════════
    # PAC-12 (6 new teams — new 17th conference)
    # ══════════════════════════════════════════════════════════════════
    {"id": "cal", "name": "California, Berkeley", "abbrev": "CAL", "mascot": "Golden Bears", "city": "Berkeley", "state": "CA", "colors": ["Blue", "Gold"], "conference": "Pac-12", "tier": 84},
    {"id": "oregon", "name": "Oregon", "abbrev": "ORE", "mascot": "Ducks", "city": "Eugene", "state": "OR", "colors": ["Green", "Yellow"], "conference": "Pac-12", "tier": 91},
    {"id": "stanford", "name": "Stanford", "abbrev": "STAN", "mascot": "Cardinal", "city": "Stanford", "state": "CA", "colors": ["Cardinal", "White"], "conference": "Pac-12", "tier": 86},
    {"id": "ucla", "name": "California, Los Angeles", "abbrev": "UCLA", "mascot": "Bruins", "city": "Los Angeles", "state": "CA", "colors": ["True Blue", "Gold"], "conference": "Pac-12", "tier": 88},
    {"id": "usc", "name": "Southern California", "abbrev": "USC", "mascot": "Trojans", "city": "Los Angeles", "state": "CA", "colors": ["Cardinal", "Gold"], "conference": "Pac-12", "tier": 93},
    {"id": "washington", "name": "Washington", "abbrev": "UW", "mascot": "Huskies", "city": "Seattle", "state": "WA", "colors": ["Purple", "Gold"], "conference": "Pac-12", "tier": 88},
    # ══════════════════════════════════════════════════════════════════
    ...
    # OTHER (2 new)
    # ══════════════════════════════════════════════════════════════════
    {"id": "greenville", "name": "Greenville", "abbrev": "GRNV", "mascot": "Panthers", "city": "Greenville", "state": "IL", "colors": ["Maroon", "White"], "conference": "Prairie Athletic Union", "tier": 58},
    {"id": "smu", "name": "Southern Methodist", "abbrev": "SMU", "mascot": "Mustangs", "city": "Dallas", "state": "TX", "colors": ["Red", "Blue"], "conference": "Border Conference", "tier": 83},
]
