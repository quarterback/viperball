...
CONF_ABBREVS = {
    # ── Real-world conferences (ESPN-style abbreviations) ──
    ...
    # ── Viperball fictional conferences (ESPN-style: short, punchy) ──
    "Southern Sun Conference": "SSC",
    "Yankee Conference": "YC",
    "Big Pacific": "BP",
    "Giant 14": "G14",
    ...
    "Potomac Athletic Conference": "POTAC",
