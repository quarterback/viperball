...
Someone in r/CFB posted a hypothetical: *What if the entire 1894 Yale team came back to life and played a modern college football team?* The discussion spiraled into something more interesting than the original question — if early football teams played under rules closer to their own era, no forward pass, heavier emphasis on kicking, no specialized roles, what would a *modern* version of that game actually look like?
